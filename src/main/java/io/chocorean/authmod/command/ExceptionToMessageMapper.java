...
public class ExceptionToMessageMapper {
  ...
  public static void init() {
    ...
    messages.put(LoginError.class, AuthModConfig.i18n.error);
  }

  public static String getMessage(GuardError e, Object ...args) {
    return String.format(messages.get(e.getClass()), args);
  }
}
