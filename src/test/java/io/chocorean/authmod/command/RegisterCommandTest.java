...
public class RegisterCommandTest {
  ...
  public void testExecute() {
    this.registrator = new Registrator(this.dataSourceStrategy);
    this.registerCommand.execute(
        null, sender, new String[] {player.getPassword(), player.getPassword()});
  ...
  public void testExecuteWithEmailRequired() {
    ...
    this.registrator = new Registrator(this.dataSourceStrategy);
    this.registerCommand.execute(
        null, sender, new String[] {player.getEmail(), player.getPassword(), player.getPassword()});
  ...
  public void testCompareTo() {
    assertEquals(
        0, this.registerCommand.compareTo(new RegisterCommand(null, new FileDataSourceStrategy())));
  }
}
