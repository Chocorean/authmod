...
public class PlayerTest {
    ...
    public void testSetUuidNullParam() {
        ...
        assertEquals(
            this.player.getUuid().length(),
            0,
            "The UUID should be empty"
        );
    }
    ...
    public void testSetUuidShortFormat() {
        ...
        assertEquals(
            this.uuid,
            this.player.getUuid(),
            "The UUID format should be X-X-X-X-X"
        );
    }
    ...
    public void testSetUuidIncorrect() {
        ...
        assertEquals(
            this.player.getUuid().length(),
            0,
            "The UUID should be empty because it is incorrect"
        );
    }
    ...
    public void testIsPremium() {
        this.player.setUuid(null);
        assertFalse(
            this.player.isPremium(),
            "The player should not be premium"
        );
    }
