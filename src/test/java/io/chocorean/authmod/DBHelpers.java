...
public class DBHelpers {
    ...
    public static String getCreationTableQuery() {
        return "CREATE TABLE players (" + "id integer PRIMARY KEY," + "email varchar(255) NOT NULL," + "password varchar(255)," + "uuid varchar(255), " + "username varchar(255) NOT NULL," + "banned INTEGER DEFAULT 0," + "UNIQUE (email)," + "UNIQUE (uuid)," + "UNIQUE (username)" + ");";
    }

    public static void initTable(IConnectionFactory connectionFactory)
        throws
            SQLException {
